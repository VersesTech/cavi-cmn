...
from cavi_cmn.utils import params_to_tx, ArrayDict, inv_and_logdet, bdot
...
class MultivariateNormal(ExponentialFamily):
    ...
    def init_default_params(
        batch_shape, event_shape, key, scale: float = 1.0, default_event_dim: int = 2
    ) -> ArrayDict:
    ...
    def shift(self, deltax):
        ...
        return MultivariateNormal(
            ArrayDict(inv_sigma_mu=inv_sigma_mu, inv_sigma=inv_sigma), residual=residual
        )
