...
if __name__ == "__main__":
    ...
    train_acc, test_acc, lpd, ece, res, _ = vmap(fit_moe_one_model)(n_model_keys)
    ...
    if args.log_runtime:
        ...
        _, _, _, _, _, _ = fit_moe_one_model(model_key)
